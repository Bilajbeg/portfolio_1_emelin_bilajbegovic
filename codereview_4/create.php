...
if (isset($_POST["create"])) {
    ...
    $sql = "INSERT INTO library (title, image, ISBN, short_description, type, author_first_name, author_last_name, publisher_name, publisher_adress, publisher_date, status) VALUES ('$title', '$image', '$ISBN', '$short_description', '$type', '$author','$author_1',   '$publisher_name', '$publisher_adress', '$publisher_date', '$status')";
    ...
    <div class="container mt-5">
        <div class="card shadow-lg">
            <div class="card-header bg-primary text-white">
                <h4 class="m-0">Create New Book Title</h4>
            </div>
            <div class="card-body">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="publisher_adress" name="publisher_adress" required>
                    </div>
                    <div class="mb-3">
                        <label for="publisher_date" class="form-label">Publisher Date</label>
                        <input type="date" class="form-control" id="publisher_date" name="publisher_date" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="short_description" name="short_description" rows="6" required></textarea>
                    </div>
